...
export class ServicesService {
  ...
  // AQUI SE INGRESAN LAS DESCRIPCIONES DE CADA ANIME
  descripciones={
  ...
  // ESTA FUNCION PERMITE ENVIAR LA DESCRIPCION SEGUN EL NOMBRE DEL ANIME
  ...
  // ESTA FUNCION DEVUELVE LOS DATOS DE CADA ANIME 
  devolver(){
    return [
      {
        anime:this.nombre,
